...
main() {
  ...
  group('Parser', () {
    ...
    test('parse section', () {
      ...
      expectNodes((nodes[1] as SectionNode).children, [TextNode('def', 11, 14)]);
    });
    ...
    test('parse section standalone tag whitespace', () {
      ...
      expectNodes((nodes[1] as SectionNode).children, [TextNode('def\n', 13, 17)]);
    });
    ...
    test('parse section standalone tag whitespace on first line', () {
      ...
      expectNodes((nodes[0] as SectionNode).children, [TextNode('def\n', 13, 17)]);
    });
    ...
    test('exception', () {
      ...
      var ex = TemplateException(
          message: 'boom!', 
          templateName: 'foo.mustache', 
          source: source, 
          offset: 2);
      ex.toString();
    });
